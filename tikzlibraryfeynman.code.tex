...
\tikzfeynmanset{warn luatex/.is if=tikzfeynman@warn@luatex}
\tikzfeynmanset{warn luatex=true}
...
%% Momentum
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\tikzfeynman@momentum@opt#1[#2]#3\pgfeov{%
  \tikzfeynmanset{#1={[#2]#3}}}

\def\tikzfeynman@momentum@std{%
  \pgfutil@ifnextchar[{\tikzfeynman@momentum@opt{momentum@@}}
  {\tikzfeynman@momentum@opt{momentum@@}[]}}
...
\def\tikzfeynman@momentum@stdr{%
  \pgfutil@ifnextchar[{\tikzfeynman@momentum@opt{reversed momentum@@}}
  {\tikzfeynman@momentum@opt{reversed momentum@@}[]}}
