...
\pgfkeys{
  ...
  /tikzfeynman/.search also={/graph drawing,/tikz/graphs,/tikz},
  /tikzfeynman/graphs/.search also={/tikz/graphs},
  /tikz/graphs/graphs/redirect unknown to tikz/.forward to=/tikz/graphs/redirect unknown to tikz,
}
...
\def\tikzfeynman@environment@feynman@opt[#1]{%
  ...
  \pgfkeys{/tikzfeynman/every feynman@@,/tikzfeynman/every feynman,#1}
...
\def\feynmandiagram@opt@opt[#1][#2]{%
  ...
  \graph [/tikzfeynman/.cd,/tikzfeynman/every diagram@@,/tikzfeynman/every diagram,/tikz/graphs/spring layout,#2]}
