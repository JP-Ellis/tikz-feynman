...
\AtBeginDocument{
  \ifLuaTeX\else%
    \iftikzfeynman@warn@luatex%
      \PackageWarning{tikz-feynman}{%
        LuaTeX is required if you wish to have vertices automatically placed. You can silence warnings by setting /tikzfeynman/warn luatex=false%
      }
    \fi%
  \fi%
}
