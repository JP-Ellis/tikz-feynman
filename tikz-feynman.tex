...
\begin{codeexample}[]
\tikz \draw[with reversed arrow] (0, 0) -- (2, 0);
\end{codeexample}
\end{key}
...
\begin{codeexample}[]
\tikz \draw[charged scalar] (0, 0) -- (2, 0);
\end{codeexample}
\end{key}
...
\begin{codeexample}[]
\tikz \draw[anti charged scalar] (0, 0) -- (2, 0);
\end{codeexample}
\end{key}
