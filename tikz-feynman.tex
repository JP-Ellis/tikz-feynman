...
\begin{minted}[fontsize=\footnotesize, bgcolor=codebackground]{diff}
...
\begin{codeexample}[]
\tikz \draw[with arrow] (0, 0) to (2, 0);
\end{codeexample}
\end{key}
...
\begin{codeexample}[]
\tikz \draw[with reversed arrow] (0, 0) to (2, 0);
\end{codeexample}
\end{key}
...
\begin{codeexample}[]
\tikz \draw[charged scalar] (0, 0) to (2, 0);
\end{codeexample}
\end{key}
...
\begin{codeexample}[]
\tikz \draw[anti charged scalar] (0, 0) to (2, 0);
\end{codeexample}
\end{key}
...
\begin{codeexample}[]
\tikz \draw[anti fermion] (0, 0) to (2, 0);
\end{codeexample}
\end{key}
...
\begin{key}{/tikz/momentum=\meta{label} (default empty)}
  Draw an arrow parallel to the edge with \meta{label} if specified.  
