...
This package's versioning will approximately \href{http://semverg.org}{semantic
  versioning}.  This means that changes in the third number (|1.0.0| to |1.0.1|)
will consist of bug fixes and other very minor changes.  Changes in the second
number (|1.0.0| to |1.1.0|) will consist of new features, and should leave the
syntax essentially unchanged.  Finally, changes in the first number (|1.0.0| to
|2.0.0|) indicates a major change in the package.  The intended version of this
package to use should be indicated in the preamble with
|\tikzfeynmanset{compat=x.y.z}| so the user may be informed of any discrepancy.
...
|\usepackage{tikz-feynman}| in the preamble.
