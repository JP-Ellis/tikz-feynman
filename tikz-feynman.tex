...
then, \LaTeX{} has become the standard type-setting software used to produce
scientific papers and currently, the two most popular methods of drawing Feynman
diagrams in \LaTeX{} are
...
\tikzfeynmanname{} is made available
...
\href{https://github.com/JP-Ellis/tikz-feynman}{Github}.
...
The original proof-of-concept for using \tikzname{} to draw Feynman diagrams was
done by the user `\href{http://tex.stackexchange.com/users/2552}{Jake}' on the
\TeX{} StackExchange.  His original answer can be viewed at:
